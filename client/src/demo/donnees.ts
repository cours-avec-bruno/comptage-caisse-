...
export class MagasinDemo {
  ...
  /**
   * La version publiée s'ouvre sur un poste déjà ouvert : elle n'a pas de
   * serveur, donc pas de session à protéger, et demander un mot de passe
   * obligerait à écrire quelque part lequel.
   */
  ...
  constructor() {
    this.semer();
    this.connecte = this.agents[0] ?? null;
  }
